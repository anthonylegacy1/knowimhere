  ...
  return (
    <div>
      ...
      <section className="border-y border-border bg-card"><div className="container-kih grid gap-5 py-14 lg:grid-cols-2">
        ...
        <article className="flex flex-col justify-between rounded-lg bg-brand p-7 text-brand-foreground"><div><span className="grid size-12 place-items-center rounded-lg bg-card text-brand"><Check /></span><p className="mt-6 text-xs font-extrabold uppercase text-brand-foreground/75">Private participation</p><h3 className="mt-2 text-4xl font-extrabold">I&apos;M HERE ✓</h3><p className="mt-3 text-brand-foreground/90">When you arrive, tap in. It closes the loop between a resource existing and a resident using it—without making your check-in public.</p></div><Button asChild className="mt-7 self-start bg-card text-brand hover:bg-card/90"><Link to="/demo">See it in the demo</Link></Button></article>
      </div></section>
      ...
      <section className="bg-ink text-cream"><div className="container-kih py-14">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          ...
          <Link to="/story" className="rounded-lg border border-brand-deep bg-brand p-6 text-brand-foreground"><span className="grid size-11 place-items-center rounded-lg bg-card text-brand"><ArrowRight /></span><p className="mt-6 text-xs font-bold uppercase text-brand-foreground/75">Connection</p><h3 className="mt-1 text-xl font-bold">Know I&apos;m Here</h3><p className="mt-2 text-sm text-brand-foreground/85">Use that confidence to connect with nearby people, resources and opportunities.</p><p className="mt-4 text-sm font-bold">Read our story →</p></Link>
        </div>
      </div></section>
