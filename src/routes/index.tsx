...
import { PRIORITIES, EXTERNAL_LINKS, VIDEOS } from "@/data/resources";
  ...
  return (
    <div>
        ...
        <div className="container-kih py-14">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-cream/65">Helping older adults confidently use the phones they already own.</p>
      ...
      <section className="mx-auto max-w-4xl px-5 py-16 text-center">
        <p className="font-display text-2xl font-bold text-brand">KNOW I&apos;M HERE</p>
        <h2 className="mt-3 font-display text-4xl font-bold leading-tight tracking-tight sm:text-5xl">
          The right Detroit resource.
          <br />
          For the right resident.
          <br />
          <span className="text-sky">At the right moment.</span>
        </h2>
        <p className="mt-4 font-medium text-foreground/60">Different challenges. One connection layer.</p>
