    ...
    <div>
      <section id="vision" className="home-hero scroll-mt-24 relative overflow-hidden">
        ...
        <div className="container-kih relative z-10 flex min-h-[34rem] flex-col items-center px-5 pb-14 pt-16 text-center text-cream sm:min-h-[39rem] sm:pb-20 sm:pt-20">
          <h1 className="max-w-4xl text-[2.6rem] font-extrabold leading-[1.06] tracking-[-0.02em] sm:text-7xl sm:tracking-normal">
            <span className="block whitespace-nowrap sm:inline sm:whitespace-normal">Your Detroit.</span>{" "}
            <span className="block whitespace-nowrap sm:inline sm:whitespace-normal">Connected to You.</span>
          </h1>
      ...
      <section id="for-you" className="container-kih scroll-mt-24 pb-14">
        ...
        <div id="community-public-health" className="mt-8 scroll-mt-24">
      ...
      <section className="container-kih pt-2 pb-14">
        <p className="text-sm font-bold uppercase tracking-wider text-sky">Finding the resource is only the first step.</p>
