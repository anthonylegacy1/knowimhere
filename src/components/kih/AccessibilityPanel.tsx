...
import zoomIcon from "@/assets/accessibility-zoom-transparent.png.asset.json";
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        ...
        >
          <img src={zoomIcon.url} alt="" width={20} height={20} className="size-5 shrink-0 bg-transparent" />
